...
## Troubleshooting <a href="#docs-internal-guid-361a9c15-7fff-0185-2f69-1125f1a3fe13" id="docs-internal-guid-361a9c15-7fff-0185-2f69-1125f1a3fe13"></a>
...
### What causes MetaReverse Prediction market to pause?
...
In the very rare occurrence that the Locked Price is exactly the same as the Closed Price, no one wins, and all funds entered into positions will be sent to the treasury to be used for $MTR buybacks to burn.
...
### What’s the MetaReverse Prediction contract address?
...
The treasury fee is currently set at 3%: this may be subject to changes, which would be announced on MetaReverse’s official communication channels. Treasury fees are used to buy back and burn $MTR tokens.

### **What are the fees?**

3% of each round's total pot will go to the treasury, which will be used to buyback and burn $MTR every Monday.

### What are you using for your price feed?

MetaReverse uses two sources for our price feeds. They each have their own purpose within the prediction market:
...
* Used for real-time price updates on the MetaReverse prediction market interface.
