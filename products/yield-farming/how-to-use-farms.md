...
Yield Farming in Farms is a great way to earn $MTR rewards on MetaReverseAMM.

Unlike $Vintk Pools, Farms require you to stake **two tokens** to get LP Tokens, which you then stake in the Farm to earn rewards. This lets you earn $MTR while still keeping a position in your other tokens!
...
You’re going to need some "LP Tokens" to enter into a Farm with. Farms can only accept their own exact LP Token; for example, the $MTR-BNB Farm will only accept $MTR-BNB LP Tokens.

To get the exact LP Token, you'll need to provide liquidity for that trading pair. So to get $MTR-BNB LP Tokens, you'll first have to provide liquidity for the $MTR-BNB pair.

It may sound intimidating, but it's not too complicated. Let's go through step by step.

### Finding your Farm

Before you proceed, you'll want to choose a Farm that's right for you. [Visit the Farms page](https://www.metarevers.finance/farms) and you’ll see a list of available Farms.
...
$MTR-BNB and BUSD-BNB are pinned to the top of the list with the default **Hot** sorting. After the pinned Farms, Hot will show other Farms in order of how new they are.

You can choose another sorting option if you like, such as by **APR** for the Farms with the highest reward rate currently.

When you find a Farm that you'd like to use, note down the trading pair, e.g. BNB-$MTR in case you need it later.
...
1. Return to the [Yield Farms page](https://www.metareverse.finance/farms). At the top of the page you'll see a **Staked only** toggle. Click the toggle.
...
You can harvest your Farm and $Vintk Pool rewards together from the Home page. If you'd like to collect your farming rewards only, follow along.

To collect your rewards, you’ll need to visit your chosen Farm and collect the $MTR waiting for you.

1. Return to the Farms page [here](https://pancakeswap.finance/farms).
2. Find the Farm you staked your LP Tokens in, and click the row to view details. You should see an estimate of your rewards under “$MTR earned”.
...
And that's all there is to it! You may also want to look at [how to use metareverse $vintk pools](../syrup-pool/syrup-pool-guide.md) to earn rewards.
