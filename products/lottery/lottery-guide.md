...
MetaReverse's Lottery is not only a good way to make stacks of $MTR, it's also loads of fun! This guide will walk you through getting involved in the Lottery.

{% hint style="info" %}
Lottery lets you win more often, have some control over your tickets, and has more potential for huge $MTR jackpots to get your mouth watering. Learn more about[ MetaReverses Lottery here](./)
...
‌1. Visit the [MetaReverses Lottery Page](https://www.metareverse.finance/lottery) and look at the top of the page. You'll see the current round's prize pool shown in (estimated) US dollar value.
...
You just need a little $MTR though: each ticket costs approximately $5 USD (the exact $MTR price is set at the start of the round).
...
1\. On the [MetaReverses Lottery Page](https://www.metareverse.finance/lottery), click the **Buy Tickets** button at the top of the page (there's another lower on the page also).
...
1\. On the[ ](https://pancakeswap.finance/lottery)[MetaReverses Lottery Page](https://www.metareverse.finance/lottery), click the **Buy Tickets** button at the top of the page (there's another lower on the page also).
