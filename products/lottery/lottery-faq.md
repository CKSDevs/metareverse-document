...
If $MTR in the prize pools isn't won it doesn't go to waste! Unclaimed $MTR rolls over to the next Lottery round.
...
* cheaper ticket prices (\~$5 USD in $MTR per ticket) that don't swing wildly with the price of $MTR
...
Each bracket's prize pool is a portion of the total $MTR in each Lottery round.

* | Bracket (numbers matched in order) | $MTR Allocation |
  | ---------------------------------- | --------------- |
  | First 1 number                     | 2%              |
  | First 2 numbers                    | 3%              |
  | First 3 numbers                    | 5%              |
...
## Can I swap my tickets back to $MTR?

No, once purchased you will not be able to convert your ticket back to $MTR.
...
## Injection schedule: When is $MTR added to the lottery?

When people buy tickets, the $MTR they spend is added to the lottery pot. In addition, a total of 20,000 $MTR is also added (injected) to lottery pots on a regular schedule over the course of eight rounds (four days).

This injection schedule started with round 84:

![Lottery injection schedule](../../.gitbook/assets/injection-schedule.png)

The cycle restarts with a new 20,000 $MTR as soon as it finishes.
